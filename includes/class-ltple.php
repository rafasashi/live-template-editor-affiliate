...
class LTPLE_Affiliate {

	/**
	 * The single instance of LTPLE_Affiliate.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $parent, $version = '1.0.0' ) {
		...
		if ( !is_admin() ) {
			...
			add_action( 'wp_head', array( $this, 'affiliate_header') );
			add_action( 'wp_footer', array( $this, 'affiliate_footer') );
		}
		...
		add_filter( 'template_include', array( $this, 'affiliate_template'), 1 );	
		
	} // End __construct ()
	
	public function affiliate_template( $template_path ){
	...
	public function affiliate_header(){
	...
	public function affiliate_footer(){
	...
	/**
	 * Main LTPLE_Affiliate Instance
	 *
	 * Ensures only one instance of LTPLE_Affiliate is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_Affiliate()
	 * @return Main LTPLE_Affiliate instance
	 */
