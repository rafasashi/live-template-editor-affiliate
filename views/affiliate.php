						...
						echo'<div class="tab-content row">';
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-info text-info">';
									...
									$this->get_affiliate_overview($this->parent->user->affiliate_clicks);
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-warning text-warning">';
									...
									$this->get_affiliate_overview($this->parent->user->affiliate_referrals);
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-success text-success">';
									...
									$this->get_affiliate_overview($this->parent->user->affiliate_commission,true,'$');									
							...
							echo'<div class=" panel panel-default" style="margin-bottom:0;">';
								...
								echo'<tbody>';
									...
									echo'<tr style="font-size:18px;font-weight:bold;">';
										...
										echo'<td>' . $this->get_affiliate_balance($this->parent->user->ID) . '</td>';
									echo'</tr>';
